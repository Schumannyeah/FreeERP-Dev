...
import org.apache.ofbiz.common.qrcode.QrImageTransform;
...
public class QRCodeServices {
    ...
    /**
     * Schumann 20240229 Streams QR Code with the result saved to local
     * directory that could be referenced later in fo.ftl .
     */
    public static Map<String, Object> generateQRCodeImageToFile(DispatchContext ctx, Map<String, Object> context) {
        Locale locale = (Locale) context.get("locale");
        String message = (String) context.get("message");
        Integer width = (Integer) context.get("width");
        Integer height = (Integer) context.get("height");
...
//            String qrCodeImagePath = "/images/qrcode/qrcode1.png";
//            ImageIO.write(bufferedImage, "png", new File(qrCodeImagePath));
//
//            Map<String, Object> result = ServiceUtil.returnSuccess();
//            result.put("qrCodeImagePath", qrCodeImagePath);
//            return result;
            // Convert the BufferedImage to base64
            String base64Image = null;
            try {
                base64Image = QrImageTransform.imageToBase64(bufferedImage, format);
            } catch (IOException e) {
