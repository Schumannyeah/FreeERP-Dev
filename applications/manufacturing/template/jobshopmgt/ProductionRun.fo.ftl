                    ...
                    <#list productionRunRoutingTasks as productionRunRoutingTask>
                        <fo:table-row>
                            <fo:table-cell>
                                ...
                                <fo:block text-align="left" font-size="7">
                                    <fo:instream-foreign-object>
                                        <barcode:barcode xmlns:barcode="http://barcode4j.krysalis.org/ns" message="${productionRunRoutingTask.workEffortId}">
                                            <barcode:code128><barcode:height>30mm</barcode:height></barcode:code128>
                                        </barcode:barcode>
                                    </fo:instream-foreign-object>
                                </fo:block>
                                ...
                                <fo:block text-align="left" font-size="7">
                                    <fo:instream-foreign-object>
                                        <service:service method="generateQRCodeImage">
                                            <service:context message="${productionRunRoutingTask.workEffortId}" 
                                                             width="200" height="200" format="png" 
                                                             encoding="UTF-8" verifyOutput="true" 
                                                             logoImage="path/to/your/logo.png" 
                                                             logoImageMaxWidth="50" logoImageMaxHeight="50"/>
                                        </service:service>
                                    </fo:instream-foreign-object>
                                </fo:block>
                                ...
                                <fo:block text-align="center">
                                    <fo:external-graphic
                                        src="/images/qrcode/${productionRunRoutingTask.workEffortId}.png"
                                        content-width="100mm" <!-- Set your desired width -->
                                        content-height="50mm" <!-- Set your desired height -->
                                        scaling="uniform" /> <!-- Ensures the aspect ratio is maintained while scaling -->
                                </fo:block>
